...
// --- 1. IMPORT DATA INSTEAD OF HARDCODING ---
...
export default function PackagesPage() {
  ...
  // Filter Logic (Filters based on 'nights' property in your data)
  ...
  return (
    <main className="min-h-screen bg-gray-50 pt-28 pb-20">
      ...
      {/* --- DISCLAIMER --- */}
      <div className="bg-orange-50 border-l-4 border-orange-500 p-4 mx-auto max-w-4xl text-left shadow-sm rounded-r-lg mb-8">
