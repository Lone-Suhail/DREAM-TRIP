      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-20 bg-gray-900 rounded-3xl p-10 md:p-16 relative overflow-hidden text-center text-white">
            ...
            <div className="relative z-10">
                ...
                <a href="tel:+919149726260" className="inline-flex items-center gap-3 bg-white text-[#1E3A8A] px-8 py-4 rounded-full font-bold hover:bg-[#D97706] hover:text-white transition-all">
