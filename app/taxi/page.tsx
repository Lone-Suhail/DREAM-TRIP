...
export default function TaxiServices() {
  ...
  return (
    <main className="min-h-screen bg-white pt-24 pb-12 font-sans">
      ...
      {/* --- HERO SECTION --- */}
      <section className="relative h-[400px] mb-20 overflow-hidden flex items-center justify-center">
                ...
                <div key={car.id} className="group bg-white rounded-[2rem] border border-gray-100 shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300">
                    ...
                    <div className="p-8">
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href={`https://wa.me/919999999999?text=I want to inquire about ${car.name}`} target="_blank" className="px-4 py-3 rounded-xl border border-gray-200 hover:border-green-500 hover:bg-green-50 text-green-600 transition-all">
                                <Phone size={20} />
                            </a>
                        </div>
                    </div>
