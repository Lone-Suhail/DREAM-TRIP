...
import { Clock, MapPin, CheckCircle, Calendar, ArrowLeft, XCircle, Star, Info, ShieldAlert, Tag } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/3">
                <div className="bg-white rounded-2xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.12)] sticky top-28 border border-gray-100">
                    ...
                    <Link href={`/book?pkg=${pkg.id}&title=${encodeURIComponent(pkg.title)}`}>
                        <button className="w-full bg-[#1E3A8A] hover:bg-blue-900 text-white font-bold py-4 rounded-xl transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 mb-3">
                            Proceed to Book
                        </button>
                    </Link>
