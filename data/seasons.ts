...
export const seasonConfig: Record<SeasonType, SeasonConfig> = {
  winter: {
    ...
    months: 'Dec - Feb',
    heroImage: '/hero-winter-gulmarg.jpg', // Make sure this image exists in public/images/
  ...
  spring: {
    name: 'Tulip Season',
    months: 'Mar - Apr',
    heroImage: '/hero-tulip-garden.jpg',
  ...
  summer: {
    name: 'Sunny Kashmir',
    months: 'May - Aug',
    heroImage: '/hero-pahalgam-green.jpg',
  ...
  autumn: {
    name: 'Golden Autumn',
    months: 'Sep - Nov',
    heroImage: 'hero-chinar-gold.jpg',
